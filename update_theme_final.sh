...
private val LightColorScheme = lightColorScheme(
    ...
    background = Color(0xFFFEFEFE), // Trick OEM Force Dark
    onBackground = Color(0xFF1C1B1F),
    surface = Color(0xFFFEFEFE), // Trick OEM Force Dark
...
fun WLEDTheme(
    ...
    val colorScheme = when (theme) {
        AppTheme.SYSTEM -> {
            // Material You (système) -> Écritures en BLANC
        ...
        AppTheme.LIGHT -> {
            // Material You (clair) -> Écritures en gris TRES FONCé
