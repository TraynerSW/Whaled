...
fun WLEDTheme(
    ...
    val colorScheme = when (theme) {
        AppTheme.SYSTEM -> {
            // Material You (système) -> Garde les couleurs dynamiques (Material You de PixelOS) mais force le texte en blanc
        ...
        AppTheme.LIGHT -> {
            // Material You (clair) -> NE PAS utiliser les couleurs dynamiques car PixelOS force le sombre dessus
            // On utilise LightColorScheme en dur pour garantir le fond clair
