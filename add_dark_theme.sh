...
fun WLEDTheme(
    ...
    val colorScheme = when (theme) {
        ...
        AppTheme.LIGHT -> {
            // Label "Material You (système)" -> fond dynamique, texte blanc
        ...
        AppTheme.DARK -> {
            // Label "Material You (Sombre)" -> Force le mode sombre de Material You, texte blanc
