...
**Whaled** (basé sur le projet [WLED](https://github.com/wled/WLED)) est une application Android légère et moderne, développée en **Kotlin** et **Jetpack Compose**, conçue pour contrôler vos appareils compatibles avec WLED.
