...
enum class AppTheme(val label: String) {
    // Si l'utilisateur a l'inversion, on force les labels à correspondre à la logique de manière croisée pour s'assurer que ça marche
...
fun WLEDTheme(
    ...
    val colorScheme = when (theme) {
        AppTheme.SYSTEM -> {
            // Label "Material You (clair)" -> on veut le fond clair, texte gris très foncé
